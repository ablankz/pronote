...
export class BranchOperationalTransformation<
    S extends BranchOperationalTransformation<S, T, U, V>,
...
> {
    ...
    innerMerge(sbt: BranchOperationalTransformation<S, T, U, V>): boolean {
